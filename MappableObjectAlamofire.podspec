...
Pod::Spec.new do |s|
  s.name             = 'MappableObjectAlamofire'
  s.version          = '0.1.0'
  s.summary          = 'A short description of MappableObjectAlamofire.'
...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'https://github.com/Arnoymous/MappableObjectAlamofire.git', :tag => s.version.to_s }
